...
class AgregarProductoImgScreen extends StatefulWidget {
  const AgregarProductoImgScreen({super.key});

  @override
  State<AgregarProductoImgScreen> createState() =>
      _AgregarProductoImgScreenState();
}

class _AgregarProductoImgScreenState extends State<AgregarProductoImgScreen> {
  String? _imagePath;
